export const TYPOGRAPHY_SCALE = {
  ...
  h5:       { font: 'heading', size: 'h5',       lineHeight: 'snug',    weight: 'semibold', transform: null,        tracking: null },
  h6:       { font: 'heading', size: 'h6',       lineHeight: 'snug',    weight: 'semibold', transform: 'uppercase', tracking: 'wide' },
  lead:     { font: 'body',    size: 'lead',     lineHeight: 'relaxed', weight: 'regular',  transform: null,        tracking: null },
  bodyLg:   { font: 'body',    size: 'bodyLg',   lineHeight: 'normal',  weight: 'regular',  transform: null,        tracking: null },
  body:     { font: 'body',    size: 'body',     lineHeight: 'normal',  weight: 'regular',  transform: null,        tracking: null },
  bodySm:   { font: 'body',    size: 'bodySm',   lineHeight: 'normal',  weight: 'regular',  transform: null,        tracking: null },
